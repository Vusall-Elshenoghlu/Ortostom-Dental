...
function DryMouth() {
  ...
  const translations = {
    az: {
      title: "Quru ağız",
      subtitle: "Quru ağızın müalicəsi səbəbdən asılı olaraq dəyişə bilər. Müayinə və diaqnoz üçün diş həkimi və ya həkimə müraciət etmək vacibdir.",
